    ...
    <div class="flex items-center">
        ...
        <div class="container flex flex-col items-center px-5 py-16 mx-auto lg:px-20 lg:py-24 xl:flex-row">
            ...
            <div class="w-6/6 mb-10 lg:max-w-lg lg:w-full xl:w-1/2 xl:mb-0">
                <img class="transform hover:rotate-2" alt="Me as a head in a jar" src="{{ asset('images/avatar.png') }}">
            </div>
    ...
    {{--                I seek to collaborate in a position that allows me to create software with these technologies.--}}
                ...
                <div class="flex items-center flex-wrap w-full -mt-4 -mx-4 text-center lg:text-left ">
                    <div class="w-1/4 p-4 mt-4 sm:w-1/4">
                        <img src="{{ asset('images/technologies/laravel.svg') }}" class="h-16 w-16 sm:h-20 sm:w-20" alt="Laravel logo">
                    </div>
                    <div class="w-1/4 p-4 mt-4 sm:w-1/4">
                        <img src="{{ asset('images/technologies/vue_logo.svg') }}" class="h-16 w-16 sm:h-20 sm:w-20" alt="Vue logo">
                    </div>
                    <div class="w-1/4 p-4 mt-4 sm:w-1/4">
                        <img src="{{ asset('images/technologies/tailwindcss_logo.svg') }}" class="h-16 w-16 sm:h-20 sm:w-20" alt="Tailwind logo">
                    </div>
                    <div class="w-1/4 p-4 mt-4 sm:w-1/4">
                        <img src="{{ asset('images/technologies/inertia_logo.svg') }}" class="h-16 w-16 sm:h-20 sm:w-20" alt="InertiaJS logo">
                    </div>
                </div>
            </div>
        </div>
