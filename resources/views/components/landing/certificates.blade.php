...
<section id="certificates" class="min-h-screen text-gray-700 body-font bg-cover bg-no-repeat relative overflow-hidden" style="background: url('{{ asset('images/splatters/splatter-dark.png') }}')">

    <div class="hidden md:block absolute bottom-0 -left-10 z-0">
        <img src="{{ asset('images/assets/7.png') }}" alt="floating dark triangle">
    </div>

    <div class="hidden md:block absolute bottom-0 right-0 z-0">
        <img src="{{ asset('images/assets/1.png') }}" alt="floating purple triangle">
    </div>
    ...
    <div class="container px-5 py-24 mx-auto">
        <div class="flex justify-center mb-12 mx-4 relative">
            ...
            <div class="hidden md:block absolute bottom-0 -right-24 z-0">
                <img src="{{ asset('images/assets/5.png') }}" alt="floating yellow triangles">
            </div>
        ...
        <div class="flex flex-wrap -m-2">
            ...
            <div class="w-full p-2 lg:w-1/3 md:w-1/2 relative z-10" >
                <a class="flex items-center h-full p-4 bg-gray-100 border border-gray-200 rounded-lg hover:bg-white" href="{{ $certification['url'] }}" target="_blank" rel="noreferrer">
                    <img alt="Certification logo" class="flex-shrink-0 object-cover object-center w-16 h-16 mr-4 bg-gray-100 rounded-full" src="images/certificates/{{ \Illuminate\Support\Str::lower($certification['technology'] . '.webp') }}">
                    <div class="flex-grow">
