    ...
    <div class="flex flex-col flex-wrap p-5 mx-auto md:items-center md:flex-row">
        <div href="/" class="lg:pl-6 focus:outline-none md:mr-auto mx-auto mb-10 md:mb-0 w-full md:w-auto">
            <div class="w-full inline-flex items-center justify-between">
                ...
                <a href="{{ asset('Software_Developer_Ariel_Mejia Resume.pdf') }}" download class="md:hidden ml-auto items-center text-sm text-white px-2 py-2 rounded-lg bg-purple-600 hover:bg-purple-700 font-semibold focus:outline-none transition duration-500 ease-in-out">Download CV</a>
            </div>
        </div>
        ...
        <a href="{{ asset('Software_Developer_Ariel_Mejia Resume.pdf') }}" download class="hidden md:block ml-auto items-center text-sm text-white px-2 py-2 rounded-lg bg-purple-600 hover:bg-purple-700 font-semibold focus:outline-none transition duration-500 ease-in-out">
            Download Resume
        </a>
    </div>
</div>
