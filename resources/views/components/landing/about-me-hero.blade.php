<section class="text-gray-700 body-font min-h-screen bg-cover bg-no-repeat relative overflow-hidden" style="background: url('{{ asset('splatter.jpeg') }}')">
    ...
    <div class="flex items-center">
        ...
        <div class="container flex flex-col items-center px-5 py-16 mx-auto lg:px-20 lg:py-24 xl:flex-row">
            ...
            <div class="w-6/6 mb-10 lg:max-w-lg lg:w-full xl:w-1/2 xl:mb-0 transform -rotate-0 sm:-rotate-12 hover:-rotate-6">
                <img class="" alt="hero" src="{{ asset('avatar.png') }}">
            </div>
                ...
                <div class="bg-purple-300 py-10 lg:px-24 px-4 bg-opacity-50">
                    ...
                    <ul class="relative z-20 block mt-6 text-sm text-gray-900 sm:text-center lg:text-left">
                            <li class="my-4">
                                ...
                                <a target="_blank" class="font-semibold text-black underline hover:text-gray-700" href="https://larapex-charts.netlify.app">Larapex Charts</a>
                            ...
                            <li class="my-4">
                                ...
                                <a target="_blank" class="font-semibold text-black underline hover:text-gray-700" href="https://devdojo.com/tails">
                                    an opensource Tailwindcss library.
                                </a>
                            </li>
                            <li class="my-4">
                                If you want to know more about me,
                                <a target="_blank" class="font-semibold text-black underline hover:text-gray-700" href="https://www.youtube.com/watch?v=BFFTHJWqx9s">here is an old podcast interview in spanish.</a>
                            </li>
                        </ul>
